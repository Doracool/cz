...
- (void)awakeFromNib {
    ...
    [_icon setTitleEdgeInsets:UIEdgeInsetsMake(5, -size.width/3, -5, size.width/3)];
    [_icon1 setImageEdgeInsets:UIEdgeInsetsMake(-size.height, size.width/2, size.height, -size.width/2)];
    [_icon1 setTitleEdgeInsets:UIEdgeInsetsMake(5, -size.width/3, -5, size.width/3)];
    [_icon2 setImageEdgeInsets:UIEdgeInsetsMake(-size.height, size.width/2, size.height, -size.width/2)];
    [_icon2 setTitleEdgeInsets:UIEdgeInsetsMake(5, -size.width/3, -5, size.width/3)];
    [_icon3 setImageEdgeInsets:UIEdgeInsetsMake(-size.height, size.width/2, size.height, -size.width/2)];
    [_icon3 setTitleEdgeInsets:UIEdgeInsetsMake(5, -size.width/3, -5, size.width/3)];
    [_icon4 setImageEdgeInsets:UIEdgeInsetsMake(-size.height, size.width/2, size.height, -size.width/2)];
    [_icon4 setTitleEdgeInsets:UIEdgeInsetsMake(5, -size.width/3, -5, size.width/3)];
    [_icon5 setImageEdgeInsets:UIEdgeInsetsMake(-size.height, size.width/2, size.height, -size.width/2)];
    [_icon5 setTitleEdgeInsets:UIEdgeInsetsMake(5, -size.width/3, -5, size.width/3)];
    [_icon6 setImageEdgeInsets:UIEdgeInsetsMake(-size.height, size.width/2, size.height, -size.width/2)];
    [_icon6 setTitleEdgeInsets:UIEdgeInsetsMake(5, -size.width/3, -5, size.width/3)];
    [_icon7 setImageEdgeInsets:UIEdgeInsetsMake(-size1.height, size1.width/2, size1.height, -size1.width/2)];
    [_icon7 setTitleEdgeInsets:UIEdgeInsetsMake(5, -size1.width/3, -5, size1.width/3)];
    [_icon8 setImageEdgeInsets:UIEdgeInsetsMake(-size1.height, size1.width/2, size1.height, -size1.width/2)];
    [_icon8 setTitleEdgeInsets:UIEdgeInsetsMake(5, -size1.width/3, -5, size1.width/3)];
    [_icon9 setImageEdgeInsets:UIEdgeInsetsMake(-size1.height, size1.width/2, size1.height, -size1.width/2)];
