...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        NSArray *tips = @[@"已收藏"];
        TTChooseBtnView *view = [[TTChooseBtnView alloc] initWithFrame:CGRectMake(12, 10, screenW-10, 50) andTags:tips andTitleColor:[UIColor lineColor] andFonts:13 withFixed:@""];
        ...
        [cell.leftBtn setBackgroundColor:[UIColor colorWithHexString:@"c9c9c9"]];
        [cell.leftBtn setTitleColor:[UIColor colorWithHexString:@"333333"] forState:UIControlStateNormal];
        cell.leftBtn.layer.borderColor = [UIColor colorWithHexString:@"333333"].CGColor;
        cell.leftBtn.layer.borderWidth = 1.0f;
        
        [cell.rightBtn setBackgroundColor:[UIColor colorWithHexString:@"4ca86b"]];
