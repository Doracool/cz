...
- (CZTabBarController *)fetchTabbarController {
    ...
    NSMutableArray * array = [[NSMutableArray alloc]initWithObjects:[UIImage imageNamed:@"学习-1"],[UIImage imageNamed:@"房源-1"],[UIImage imageNamed:@"客源-1"],[UIImage imageNamed:@"计算器-1"],[UIImage imageNamed:@"个人-1"], nil];
    NSMutableArray * selectedArray = [[NSMutableArray alloc]initWithObjects:[UIImage imageNamed:@"学习选中"],[UIImage imageNamed:@"房源选中-1"],[UIImage imageNamed:@"客源选中-1"],[UIImage imageNamed:@"计算器选中-1"],[UIImage imageNamed:@"个人选中-1"], nil];
